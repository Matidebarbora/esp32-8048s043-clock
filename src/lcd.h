...
#define LCD_PIXEL_CLOCK_HZ     (14 * 1000 * 1000)  // lowered from 18 MHz — more DMA margin under heavy SW-render load.
                                                    // 12 MHz was tried and broke sync entirely (random-color garbage
                                                    // display on boot) — do not go below 14 MHz on this panel.
...
// Sets backlight brightness via LEDC PWM, 0-100 (%). Configures the LEDC
// timer/channel lazily on first call.
